...
function DropdownProfile({ align }) {
  ...
  return (
    <>
            ...
            <ul>
              <li>
                <button
                  ...
                  onClick={() => {
                    document.getElementById("resetPasswords").showModal();
              ...
              <li>
                <Link
                  ...
                  to="/"
                  onClick={() => {
                    handleLogout(), setDropdownOpen(!dropdownOpen);
                  }}
                >
                  Sign Out
                </Link>
      ...
      <ModalResetPassword idModal="resetPasswords" selectedData={usersExist} />
    </>
  );
}
